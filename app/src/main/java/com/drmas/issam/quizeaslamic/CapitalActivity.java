...
public class CapitalActivity extends AppCompatActivity {
    ...
    private Toolbar capitalToolbar;
    private Button textCounterDownCapital;

    private CapitalQuestions capitalQuestions = new CapitalQuestions();
    private TextView mQuestionViewCapital;

    private Button mButtonChoice1Capital, mButtonChoice2Capital;
    private Button mButtonChoice3Capital, mButtonChoice4Capital;

    private TextView textCorrectCountCapital, textWrongCountCapital,
            countQuestionDownCapital;
    /// ending of main page
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        capitalToolbar = findViewById( R.id.capitalToolbar );
        setSupportActionBar( capitalToolbar );
        setTitle( null );

        myDialog = new Dialog( this );

        textCorrectCountCapital = (TextView) findViewById( R.id.textCorrectCountCapital);
        textWrongCountCapital = (TextView) findViewById( R.id.textWrongCountCapital );
        countQuestionDownCapital = (TextView) findViewById( R.id.countQuestionDownCapital);

        textCounterDownCapital = (Button) findViewById( R.id.counterDownCapital);
        countDownTimer = new CountDownTimer(16000, 1000) {
            @Override
            public void onTick(long millisUntilFinished) {
                textCounterDownCapital.setText(""+ millisUntilFinished/1000 );
            }

            @Override
            public void onFinish() {
                textCounterDownCapital.setText( "done" );
        ...
        mQuestionViewCapital = (TextView) findViewById( R.id.textQuestionCapital );

        mButtonChoice1Capital = (Button) findViewById( R.id.ButtonChoice1Capital );
        mButtonChoice2Capital = (Button) findViewById( R.id.ButtonChoice2Capital );
        mButtonChoice3Capital = (Button) findViewById( R.id.ButtonChoice3Capital );
        mButtonChoice4Capital = (Button) findViewById( R.id.ButtonChoice4Capital );
    ...
    private void ShowPopup() {
        ...
        mScoreView.setText( "Score "+ mScore+ "/" +capitalQuestions.getLength()+ " ");
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( CapitalActivity.this, HeightScore.class );
                intent.putExtra( "scoreCapital", mScore );
            ...
            if (heightScore == 0){
                ...
                btnCancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent( CapitalActivity.this, HeightScore.class );
                        intent.putExtra( "scoreCapital", heightScore );
                        startActivity( intent );
        ...
        if (heightScore == 100){
            ...
            btnFinishScore.setOnClickListener( new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent( CapitalActivity.this, HeightScore.class );
                    intent.putExtra( "scoreCapital", 100 );
                    startActivity( intent );
                }
            });
    ...
    public void correctCount(){
        ...
        correctCountCounter++;
        textCorrectCountCapital.setText(String.valueOf( correctCountCounter ));
    ...
    public void wrongCount(){
        ...
        wrongCountCounter++;
        textWrongCountCapital.setText(String.valueOf( wrongCountCounter ));

    }

    public void countQuestionDown(){
        questionsDown--;
        countQuestionDownCapital.setText( String.valueOf( questionsDown ));
    }
    ...
    private void updateQuestions(){
        ...
        if (mQuestionNumber<capitalQuestions.getLength()){

            mQuestionViewCapital.setText( capitalQuestions.getQuestions( mQuestionNumber ));

            mButtonChoice1Capital.setText( capitalQuestions.getChoice( mQuestionNumber, 1));
            mButtonChoice2Capital.setText( capitalQuestions.getChoice( mQuestionNumber, 2));
            mButtonChoice3Capital.setText( capitalQuestions.getChoice( mQuestionNumber, 3));
            mButtonChoice4Capital.setText( capitalQuestions.getChoice( mQuestionNumber, 4));

            mAnswer = capitalQuestions.getCorrectAnswer( mQuestionNumber );
            mQuestionNumber++;
    ...
    public void onClickBtnCapital(View view){
    ...
    public void mainActivity(){
        Intent intentMain = new Intent(CapitalActivity.this, MainActivity.class);
    ...
    protected void onStart() {
        ...
        TextView titleTextDialog = (TextView) layout.findViewById( R.id.titleTextDialog );
        titleTextDialog.setText( " أسئلة عن العواصم ");
    ...
    private void showAnswer() {
        ...
        webView.loadUrl("file:///android_asset/"+capital+".html");
