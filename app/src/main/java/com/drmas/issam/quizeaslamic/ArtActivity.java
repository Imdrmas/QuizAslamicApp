...
public class ArtActivity extends AppCompatActivity {
    ...
    public Button textCounterDownArt;
    ...
    private TextView textCorrectCountArt, textWrongCountArt, countQuestionDownArt;
    /// ending of main page
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        artToolbar = findViewById( R.id.islamicToolbar );
    ...
    private void ShowPopup() {
        ...
        mScoreView.setText( "Score "+ mScore+ "/" +artQuestions.getLength()+ " ");
    ...
    protected void onStart() {
        ...
        TextView titleTextDialog = (TextView) layout.findViewById( R.id.titleTextDialog );
        titleTextDialog.setText( "أسئلة في الفنون");
